...
export const opsRoutes = {
  ...
  opsVendorShowcase: route({
    method: "GET",
    path: "/ops/vendors/:id/showcase",
    audience: "staff",
    params: idParam,
    summary: "vendors.view — work and achievements, including those awaiting review",
  }),
  opsReviewPortfolioItem: route({
    method: "POST",
    path: "/ops/portfolio/:id/review",
    audience: "staff",
    params: idParam,
    body: verificationReviewSchema,
    summary: "vendors.verify — approve, send back, or take down posted work",
  }),
  opsReviewAchievement: route({
    method: "POST",
    path: "/ops/achievements/:id/review",
    audience: "staff",
    params: idParam,
    body: verificationReviewSchema,
