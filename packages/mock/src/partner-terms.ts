...
export const partnerTerms: PartnerTerms = {
  ...
  summary:
    "What you can expect from Decora Shine, what we expect from you, and how commission is calculated. Version 2026.1, effective 1 January 2026.",
  sections: [
    {
      heading: "1. What this agreement covers",
      body: "This agreement governs your use of the Decora Shine platform to receive customer enquiries, submit quotations, and carry out work for customers introduced to you by Decora Shine. It does not make you an employee, agent or partner of Decora Shine. You remain an independent business, responsible for your own crew, materials, tools, insurance and taxes.",
    },
    {
    ...
    {
      heading: "3. Customer contact is coordinated by Decora Shine",
      body: "Decora Shine does not share customer telephone numbers or email addresses with you. You receive the locality of the job when it is assigned, and the full site address once a visit has been confirmed. All questions to a customer, and all answers back, go through the Decora Shine coordinator. You agree not to solicit a customer's direct contact details, not to contact them outside the platform, and not to offer to carry out the introduced work off-platform. This clause is what allows us to keep the enquiry free for customers.",
    },
    {
      heading: "4. Quoting",
    ...
    },
    {
      ...
      body: "If a project is cancelled before work has started, commission on it is waived. If work has started, commission stands at the agreed amount unless Decora Shine adjusts it, which we may do at our discretion where the cancellation was not your fault. Any adjustment and its reason is recorded against the invoice.",
    },
    {
      heading: "7. Standards of work",
      body: "You will carry out work to the specification and timeline in your accepted quote, using the materials you specified. You will honour the warranty you offered. Where a customer raises a complaint through Decora Shine, you will respond within two working days and work with our team in good faith to resolve it.",
    },
    {
  ...
  acknowledgements: [
    {
      key: "contact",
      label:
        "I will not ask customers for their direct contact details, contact them off-platform, or offer to do the introduced work outside Decora Shine.",
    },
    {
      key: "commission",
      label:
