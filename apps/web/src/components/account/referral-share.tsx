...
export function ReferralShare({
  ...
  const message = `I used Decora Shine to get three quotes for work on my home — interiors, furniture, fabrication and painting. Use my code ${code} and we both get ₹${reward}. ${shareUrl}`;
