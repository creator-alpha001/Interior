      ...
      <PageBody className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          <Metric
            ...
            href="/partner/leads?filter=new"
          />
          <Metric label="Quotes out" value={dashboard.quotesOut} hint="Client deciding" href="/partner/leads?filter=quoting" />
          <Metric label="Live jobs" value={dashboard.liveProjects} hint="In progress" href="/partner/projects" />
          <Metric
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Panel
            title="Needs a quote"
            action={
              <Link href="/partner/leads?filter=new" className="text-[12px] font-medium text-brand">
                All →
              </Link>
            }
            bodyClassName="p-0"
        ...
        {dashboard.commissionDue + dashboard.commissionOverdue > 0 ? (
          <div className="rounded-lg border border-clay-line bg-clay-soft p-4">
            ...
            <p className="mt-1 text-[12.5px] leading-relaxed text-ink-2">
              ...
              <Link href="/partner/payments" className="font-medium text-brand">
                See payments
              </Link>
            </p>
          </div>
