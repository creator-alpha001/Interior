      ...
      <Section tone="surface">
        <Container width="wide">
          <SectionHeading
            ...
            description="Every professional on Decora Shine is approved per trade, not in general — so a fabricator only receives fabrication leads unless they are separately approved for painting."
          />
          {/*
